...
class DetailActivity : AppCompatActivity(), DetailView {
    ...
    private lateinit var data: DetailItem
    ...
    private fun setupLayout(data: DetailItem) {
        relativeLayout {
            dataView = scrollView {
                linearLayout {
    ...
    private fun setupEnv(data: DetailItem) {
