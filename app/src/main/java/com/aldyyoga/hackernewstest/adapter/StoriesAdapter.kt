package com.aldyyoga.hackernewstest.adapter
...
import com.aldyyoga.hackernewstest.utils.DateTime
import org.jetbrains.anko.*

class StoriesAdapter(private val items: List<DetailItem>,
                     private val clickListener: (DetailItem) -> Unit) : RecyclerView.Adapter<StoriesAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(val view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bind(item: DetailItem, clickListener: (DetailItem) -> Unit) {
